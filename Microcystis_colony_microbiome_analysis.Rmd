...
```
We removed 56 OTUs flagged as rare, keeping ~88%.
...
```
A total of 68 OTUs were removed as either rares or contaminants, keeping 86% of the total OTUs.
...
mantel_OTU_abund <- as.matrix(mantel_df[,2:405]) #The as.matrix will convert from factor to character (necessary step)
...
full_alpha_hist <- colony_alpha_hist / field_alpha_hist / Filt_alpha_hist
full_alpha_hist
